...
export default function BracketTree() {
  ...
  if (currentTournament && !canView) {
    return <PrivateTournamentFallback t={t} />;
  }
...
/* ─── Private Tournament Fallback ─── */

function PrivateTournamentFallback({ t }: { t: any }) {
  return (
    <div className="flex flex-col items-center justify-center py-24 px-4 text-center gap-4 animate-card-enter">
      ...
      <h2 className="text-xl font-bold text-on-surface font-[Sora]">
